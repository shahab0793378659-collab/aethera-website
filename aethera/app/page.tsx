    ...
    <>
      ...
      <main className="relative">
        ...
        >
          <div
            id="hero-overlay"
            className="absolute inset-0 bg-gradient-to-b from-black/90 via-black/60 to-black/55 transition-all duration-700 md:from-black/95 md:via-black/70 md:to-black/65"
          />
          <div className="absolute inset-0 [box-shadow:inset_0_0_120px_rgba(0,0,0,0.55)]" />

          <div
            id="hero-text"
            className="relative mx-auto flex h-full max-w-6xl flex-col items-center justify-center px-6 text-center transition-all duration-500"
          >
            <p className="text-xs font-semibold uppercase tracking-[0.25em] text-black/80 md:text-white/80">
              Klinik Aethera
            </p>

            <h1 className="mt-5 text-4xl font-semibold leading-[1.05] text-black/90 md:text-6xl md:text-white">
              Estetiska injektionsbehandlingar
            </h1>

            <p className="mt-6 max-w-2xl text-base text-black/80 md:text-lg md:text-white/85">
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-3">
              <a
                href="#behandlingar"
                className="rounded-2xl border border-black/35 px-6 py-3 font-medium text-black transition hover:bg-black/5 md:border-white/70 md:text-white md:hover:bg-white/10"
              >
                Våra behandlingar
              </a>
            </div>

            <div className="mt-12 w-full max-w-4xl rounded-3xl border border-black/10 bg-white/30 p-6 shadow-[0_20px_60px_rgba(0,0,0,0.08)] backdrop-blur-md md:border-white/10 md:bg-white/10">
              <div className="grid grid-cols-1 gap-6 text-sm md:grid-cols-3">
                <div>
                  <p className="font-semibold text-black/85 md:text-white">
                    Konsultation
                  </p>
                  <p className="text-black/65 md:text-white/75">
                ...
                <div>
                  ...
                  <p className="text-black/65 md:text-white/75">Vetlanda</p>
                </div>
                <div>
                  <p className="font-semibold text-black/85 md:text-white">
                    Bokning
            ...
            <div className="mt-10 text-xs text-black/65 md:text-white/60">
          ...
          <div className="mx-auto max-w-6xl px-6">
            <div className="text-center">
              ...
              <p className="mx-auto mt-4 max-w-2xl text-gray-600">
                ...
                <span className="font-semibold">48 timmar</span> innan
                behandling.
              </p>
            </div>
            ...
            <div className="mt-14 grid grid-cols-2 gap-4 lg:grid-cols-4">
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="group relative flex h-12 w-12 items-center justify-center overflow-hidden rounded-2xl border border-white/50 bg-white/45 shadow-md backdrop-blur-lg transition-transform duration-300 hover:scale-105 sm:h-14 sm:w-14">
              ...
              >
                ...
                <ul className="mt-4 space-y-1.5 text-sm text-gray-800 sm:text-base">
                  ...
                  <li>Minst <span className="font-semibold">48 timmar</span></li>
            ...
            <div className="mt-12 flex justify-center">
              <a
                href="#boka"
                className="inline-flex rounded-2xl border border-gray-300 px-7 py-3 font-medium transition hover:-translate-y-0.5 hover:bg-gray-50"
              >
                Se tider & boka
              </a>
            </div>
            ...
            <div className="rounded-3xl border border-[#E8E0D7] bg-[#F5F1EC] p-10 shadow-[0_20px_60px_rgba(0,0,0,0.04)] transition duration-300 hover:shadow-[0_24px_70px_rgba(0,0,0,0.06)] md:p-12">
              <div className="grid grid-cols-1 gap-10 md:grid-cols-3">
                ...
                <div className="space-y-4 text-gray-800">
                  ...
                  <a
                    href="/vanliga-fragor"
                    className="inline-flex rounded-2xl border border-gray-300 px-6 py-3 font-medium transition hover:-translate-y-0.5 hover:bg-white/60"
                  >
                    Vanliga frågor
                  </a>
                </div>
